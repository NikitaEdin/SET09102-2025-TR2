...
namespace REA.Tests.Services {
    ...
    public class FakeDatabaseService : IDatabaseService {
        ...
        public List<Sites> Sites { get; set; } = new List<Sites> {
            new Sites { siteName = "Edinburgh Nicolson Street", latitude = 55.94476f, longitude = -3.183991f, evelvation = 0, timezone = "", utcOffset = 0, type = "Urban Traffic", zone = "Central Scotland", agglomeration = "Edinburgh Urban Area", localAuthority = "Edinburgh" },
            new Sites { siteName = "Glencorse B",               latitude = 55.86111111f, longitude = 3.25388889f, evelvation = 0, timezone = "", utcOffset = 0, type = "Water Quality", zone = "", agglomeration = "", localAuthority = "" },
            new Sites { siteName = "",                          latitude = 55.008785f, longitude = -3.5856323f, evelvation = 8, timezone = "", utcOffset = 0, type = "Weather", zone = "", agglomeration = "", localAuthority = "" }
        };
        ...
        public List<Metadata> MetadataList { get; set; } = new List<Metadata> {
            new Metadata { Category = "Air quality", Quantity = "Nitrogen dioxide", Symbol = "NO2", Unit = "ug/m3", Unit_desc = "microgrammes per cubic metre", Measurement_freq = "Hourly", Safe_level = 200, Reference_url = "https://uk-air.defra.gov.uk/air-pollution/daqi?view=more-info&pollutant=no2#pollutant", Sensor = "Airly", Sensor_ID = null },
            new Metadata { Category = "Water quality", Quantity = "Nitrite", Symbol = "-NO3", Unit = "mg/l", Unit_desc = "milligrammes per litre", Measurement_freq = "Hourly", Safe_level = 3, Reference_url = "https://cdn.who.int/media/docs/default-source/wash-documents/water-safety-and-quality/chemical-fact-sheets-2022/nitrate-and-nitrite-fact-sheet-2022.pdf?sfvrsn=a65406e9_2&download=true", Sensor = "ClearWater", Sensor_ID = null },
            new Metadata { Category = "Weather", Quantity = "Air temperature", Symbol = "T", Unit = "C", Unit_desc = "Degrees Celcius", Measurement_freq = "Hourly", Safe_level = 0, Reference_url = "", Sensor = "Netvox R712", Sensor_ID = null }
        };
